            ...
            <ScrollView keyboardDismissMode='interactive' automaticallyAdjustKeyboardInsets>
                <View style={styles.contentContainer}>
                    ...
                    <Pressable onPress={() => setIsCameraOpen(true)} style={styles.addImageBox}>
                        {image ? (
                            <Image source={{ uri: image }} style={{ resizeMode: 'cover', width: '100%', height: 300 }} alt='Hmmmmm' />
                        ) : (
                    ...
                    <View style={styles.textFieldContainer}>
                        ...
                        <TextInput onChangeText={setTitleText} value={titleText} style={styles.textfield} placeholder='Skriv inn tittel' />
                    </View>
                    <View style={styles.textFieldContainer}>
                    ...
                    <View style={styles.textFieldContainer}>
                        ...
                        <TextInput onChangeText={setHashtagText} value={hashtagText} style={styles.textfield} placeholder='#kultur #natur #mat' />
                    </View>
